...
@Component({
  selector: 'app-preliminary-advanced',
  templateUrl: './preliminary-advanced.component.html',
  styleUrls: ['./preliminary-advanced.component.scss']
})
export class PreliminaryAdvancedComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      const pageId = 'preliminary-advanced';
      ...
      this.decisionService.fetch(this.jurId, caseId, pageId, this.typeId).subscribe(decision => {
          ...
          console.log('Prelim is = >', decision);
  ...
  onSubmit() {
      ...
      this.pageValues.visitedPages['preliminary-advanced'] = true;
